...
interface AvailabilityService {
    suspend fun getAvailability(personalTrainerId: String, month: String): Availability
    ...
    suspend fun isAvailable(personalTrainerId: String, month: String): CheckAvailability
}
...
class AvailabilityServiceImpl(
    ...
    override suspend fun getAvailability(
        ...
        val updatedSlots = availability.slots.map { slot ->
            slot.copy(
    ...
    override suspend fun updateAvailability(availability: Availability) {
        availabilityRepository.save(availability).takeIf { availabilityRepository.existsByPersonalTrainerId(availability.personalTrainerId) }
    }
    ...
    override suspend fun isAvailable(
        ...
        val isAvailable = availability.slots.any { slot ->
            slot.times.any { time ->
