...
@Service
class GymLocationsServiceImpl(private val repository: GymLocationsRepository) : GymLocationsService {

    override suspend fun findAllGymLocations(): Flow<GymLocation> {
        return repository.findAll()
    }

    override suspend fun saveGymLocation(gymLocation: GymLocation): GymLocation {
        return repository.save(gymLocation)
    }
