...
data class Client(
    ...
    @field:NotBlank(message = "First name is mandatory") val firstName: String,
    @field:NotBlank(message = "Last name is mandatory") val surname: String,
    @field:NotBlank(message = "Strength level is mandatory")
    @field:NotNull
    val strengthLevel: String,
    @field:Valid val gymPlan: GymPlan,
)

@Document
data class GymPlan(
    @field:NotBlank(message = "Name is mandatory") val name: String,
    @field:Valid val personalTrainer: PersonalTrainer,
    @field:FutureDate
    @field:NotNull(message = "Start date is mandatory")
    val startDate: LocalDateTime,
    @field:FutureDate @field:NotNull(message = "End date is mandatory") val endDate: LocalDateTime,
...
data class PersonalTrainer(
    ...
    @field:Size(min = 2, message = "First name minimum 2 characters allowed") val firstName: String,
    @field:Size(min = 2, message = "Last name minimum 2 characters allowed") val surname: String,
    val imageUrl: String,
    val bio: String,
