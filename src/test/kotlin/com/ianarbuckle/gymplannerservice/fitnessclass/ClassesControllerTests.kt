...
class ClassesControllerTests {
    ...
    fun `should return all fitness classes by day of week`() = runTest {
        ...
        // When & Then
        webTestClient.get().uri("/api/v1/fitness_class?dayOfWeek=Monday")
    ...
    fun `should save fitness class`() = runTest {
        ...
        // When & Then
        // When & Then
        webTestClient.post().uri("/api/v1/fitness_class")
    ...
    fun `should update fitness class`() = runTest {
        ...
        // When & Then
        webTestClient.put().uri("/api/v1/fitness_class")
            .contentType(MediaType.APPLICATION_JSON)
    ...
    fun `should delete fitness class by id`() = runTest {
        ...
        // When & Then
        webTestClient.delete().uri("/api/v1/fitness_class/1")
            .exchange()
            .expectStatus().isOk
    }
}