...
class FacilityStatusControllerTests {
    ...
    @Test
    fun `should return all machines`() =
        runTest {
            // Given
            val facilities =
                listOf(
    ...
    @Test
    fun `should return facilities by gym location`() =
        runTest {
            // Given
    ...
    @Test
    fun `should return machine by id`() =
        runTest {
            // Given
    ...
    @Test
    fun `should return 404 when updating machine that does not exist`() =
        runTest {
            // Given
            val facility = FacilityStatusDataProvider.createFacilityStatus()
    ...
    @Test
    fun `should delete facility by id`() =
        runTest {
            // Given
            val facility = FacilityStatusDataProvider.createFacilityStatus()
            `when`(facilityStatusService.findMachineById("1")).thenReturn(facility)
    ...
    @Test
    fun `should return 404 when deleting machine that does not exist`() =
        runTest {
            // Given
            `when`(facilityStatusService.findMachineById("999")).thenReturn(null)
    ...
    @Test
    fun `should create batch of facilities`() =
        runTest {
            // Given
            val facilities =
                listOf(
    ...
    @Test
    fun `should delete all facilities by gym location`() =
        runTest {
            // Given
            val gymLocation = GymLocation.CLONTARF
    ...
    @Test
    fun `should return 400 when creating facility with invalid status`() =
        runTest {
            // Given
            val invalidBody =
                """
    ...
    @Test
    fun `should return 400 when creating facility with invalid location`() =
        runTest {
            // Given
            val invalidBody =
                """
    ...
    @Test
    fun `should return 400 when creating batch with invalid status`() =
        runTest {
            // Given
            val invalidBody =
                """
    ...
    @Test
    fun `should return facilities by status`() =
        runTest {
            // Given
