...
class FacilityStatusServiceTests {
    ...
    @Test
    fun `should return machines by gym location`() =
        runTest {
            // Given
    ...
    @Test
    fun `should return machines by status`() =
        runTest {
            // Given
    ...
    @Test
    fun `should return null when machine not found by id`() =
        runTest {
            // Given
