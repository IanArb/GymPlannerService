...
class GymLocationsServiceTests {
    ...
    private val gymLocationsService: GymLocationsService =
        GymLocationsServiceImpl(gymLocationsRepository)
    ...
    @Test
    fun `test save gym location`() = runTest {
    ...
    @Test
    fun `test update gym location`() = runTest {
    ...
    @Test
    fun `test delete gym location by id`() = runTest {
