...
@WebFluxTest(controllers = [PersonalTrainerController::class], excludeAutoConfiguration = [ReactiveSecurityAutoConfiguration::class])
...
class PersonalTrainerControllerTests {
    ...
    fun `should return all personal trainers by gym location`() = runTest {
        ...
        webTestClient.get().uri("/api/v1/personal_trainers?gymLocation=CLONTARF")
    ...
    fun `should create personal trainer`() = runTest {
        ...
        webTestClient.post().uri("/api/v1/personal_trainers")
    ...
    fun `should update personal trainer`() = runTest {
        ...
        webTestClient.put().uri("/api/v1/personal_trainers")
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(personalTrainer)
            .exchange()
            .expectStatus().isOk
    ...
    fun `should delete personal trainer by id`() = runTest {
        ...
        webTestClient.delete().uri("/api/v1/personal_trainers/1")
            .exchange()
            .expectStatus().isOk
    }
}